...
//fetch single item
$random_product = DB::table('products')->inRandomOrder()->first();
        ...
        <div class="col-12">
            <div class="card theme-bg">
                ...
                <div class="card-body py-3">
                    <div class="row">
                        <div class="col-auto align-self-center">
                            <h6><span class="fw-light">10% OFF</span><br />{{ $random_product->name }}</h6>
                        </div>
            ...
            <div class="card-body py-3">
                <div class="row">
                    <div class="col-10 align-self-center">
                        ...
                        <p>Shop over 100,000KES to get free delivery.</p>
                    </div>
                </div>
            </div>
        </div>
